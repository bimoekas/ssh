...
export default function KategoriBarangForm(props) {
    ...
    const isEditing = props.kategori_barang ? true : false; //Boolean(props.kategori_barang)
    ...
    function onSubmit(e) {
        ...
        const submitUrl = isEditing
            ? route("kategori-barang.update", props.kategori_barang.id)
        ...
        <form onSubmit={onSubmit}>
            ...
            <div>
                <Listbox
                    ...
                    onChange={(value) => setData("id_kategori", value)}
                >
                    {({ open }) => (
                        <>
